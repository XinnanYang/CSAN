...
if __name__ == '__main__':
    ...
    anchor_i2t_dict, anchor_t2i_dict = extract_rank_index(sims_baseline, top_capk=5, top_imgk=5, better_mode=True,
    ...
    rank_i2t_dict, rank_t2i_dict = extract_target_index(sims_target, top_capk=5, top_imgk=5, include_capnum=2,
                                                        anchor_i2t_dict=anchor_i2t_dict,
                                                        anchor_t2i_dict=anchor_t2i_dict)
